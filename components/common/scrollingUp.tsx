...
const ScrollingUp: React.FunctionComponent<ScrollingUpProps> = () => {
        ...
        return (
                <div
                        className={`flex flex-col items-center justify-between rounded cursor-pointer  ${
                                height * 3 - 100 <= scrollY ? "translate-y-0" : "translate-y-48"
                        } bg-gray-800 transform duration-300`}
